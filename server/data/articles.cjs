/**
 * @fileoverview Articles data module for the backend server.
 * Contains the article data used by the API endpoints.
 ...
 * @property {string} image - URL of cover image
 * @property {string} content - Full article text
